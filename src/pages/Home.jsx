  ...
  return (
    <>
      ...
      <main>
        ...
        <div className="container quote_home">
          <figure>
            <blockquote className="blockquote">
              <p>"Life is the bubbles when you aren't worried about your carbon footprint."</p>
            </blockquote>
            <figcaption className="blockquote-footer">
              <cite title="Source Title"> The Team</cite>
            </figcaption>
          </figure>
        </div>

        <div className="container-fluid we_are_home">
          <div className="container d-flex yUs">
            <div>
            ...
            <div>
              <h2>Why Us?</h2>
              <p>
                Because we know what it's like to want something beautiful that doesn't cost the Earth (or the Sea). We bring a fresh, youthful perspective to the e-commerce world, fueled by salt water, sunlight, and a blatant refusal to wear uncomfortable shoes.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container-fluid">
          <div className="container home_stay">
            <div>
              <h2>Stay Salty</h2>
              <p>
                Whether you're a land-dweller or a fellow sea-soul, we're glad you're here. Dive into our collection and find something that makes a splash.
              </p>
            </div>
          </div>
        </div>
